...
<div class="container">
  ...
  <!-- /. PAGE TITLE-->
    <% if(request.getAttribute("msgdstudung")!=null)
      {
    %>
    <div class="row">
		...
		<div class="span6">
			<div class="media">
				<p style="color:red">${msgdstudung }</p>
	...
	<div class="row">
	<c:forEach items="${listvocatopic}" var="list">
		<div class="topicvoca">
			<div class="media">
				 <a href="#" class="pull-left"><img src="Image_AudioVocabulary/${list.vocabularyimage }" class="media-object" alt='' width="128px" height="128px"/></a>
				<div class="media-body">
					
					<p>
					${list.vocabularyname }
					</p>
					<a href="ContentVocabulary?idvocabularyguideline=${list.idvocabularyguideline }" class="btn" type="button">Hiển thị từ vựng</a>
			...
			<div class="pagination" id="paral">
				<ul>
					<c:if test="${numberpage==1}"> 
						...
						<li><a href="DisplaylistVocabularyTopic?pageid=${numberpage+1}">Next</a></li>
					</c:if>
					
					<c:if test="${numberpage==maxpageid}"> 
					    <li><a href="DisplaylistVocabularyTopic?pageid=${numberpage-1}">Prev</a></li>
