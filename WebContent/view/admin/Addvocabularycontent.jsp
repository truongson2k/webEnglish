...
<head>
<meta charset="UTF-8">
<title>Thêm nội dung từ vựng</title>
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										...
										<form action="Addvocabularycontent?idvocabularyguideline=<%=request.getAttribute("idvocabularyguideline") %>" method="post" enctype="multipart/form-data">
												<fieldset>
												<span style="color: red">${messageError}</span>
												  <label class="block clearfix">
												  <%=request.getAttribute("msgvocacontent")!=null?request.getAttribute("msgvocacontent"):""%>
												  </label>
													<label class="block clearfix">
