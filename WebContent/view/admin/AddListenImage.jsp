									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Thêm hình bài tập nghe
											</h4>

											<div class="space-6"></div>

										<form action="UploadListenImage?idlistenexercise=<%=request.getAttribute("idlistenexercise") %>" method="post" enctype="multipart/form-data">
												<fieldset>
												<span style="color: red">${messageError}</span>
												  <label class="block clearfix">
												  <%=request.getAttribute("msglistimage")!=null?request.getAttribute("msglistenimage"):""%>
												  </label>
													<label class="block clearfix">
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-70 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm hình bài tập nghe</span>
														</button>
													</div>
