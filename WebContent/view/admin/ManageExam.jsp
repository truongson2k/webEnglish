...
<div class="page-content">
	<c:if test="${msgmanageexam!=''}">
		<h4 class="pink">
			<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
			<a  class="green" data-toggle="modal">${msgmanageexam }</a>
		</h4>
	</c:if>
				...
				<table id="simple-table" class="table  table-bordered table-hover">
					...
					<tbody>		
                          <c:forEach items="${listexam}" var="listexam">
										<tr>
											<td class="center">
												<c:out value="${listexam.idexamination}" />	
											</td>
											<td class="center">
										 		<c:out value="${listexam.examinationname}" />		
											</td>
											<td class="center">
												<c:out value="${listexam.examinationimage }" />		
											</td>
											<td class="center">
												<a class="red" href="DeleteExam?idexamination=${listexam.idexamination}">
													<i class="ace-icon fa fa-trash-o bigger-130"></i>
												</a>
											</td>
											<td class="center">
													<a class="green" href="Addexamquestions?idexamination=${listexam.idexamination }">
														<ul class="list-unstyled">
															<c:if test="${listexam.checked==1}">
															    <li>
														            <i class="ace-icon fa fa-check-square-o"></i>
												            	</li>
												      	    </c:if>
												           	<c:if test="${listexam.checked==0}">
															     <li>
		...
		<div>
			<ul class="pagination">		
               ...
               <c:if test="${numberpage==1 }"> 
					...
					<li><a href="Listexam?pageid=${numberpage+1}">Next</a></li>
			   </c:if>
	
				<c:if test="${numberpage==maxpageid}"> 
					    <li><a href="Listexam?pageid=${numberpage-1}">Prev</a></li>   
...
<div class="row">
 ...
 <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
       <form action="AddExamname" method="post">
    	  <!-- Modal content-->
      ...
      <div class="modal-body">
		<div class="form-group">
         	<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Thêm đề bài: </label>
				<div class="col-sm-9">
					<input type="text" id="form-field-1-1" placeholder="Nhập tên bài hướng dẫn" class="form-control" name="examinationname"/>
				</div>
		</div>
 ...
 <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
       <form action="Addexamaudioimage" method="post" enctype="multipart/form-data">
    	  <!-- Modal content-->
      	<div class="modal-content">
       		 <div class="modal-header">
         		 <button type="button" class="close" data-dismiss="modal">&times;</button>
