...
<title>Thêm Danh Sách Chủ Đề Từ Vựng</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Danh Sách Kiểm Tra Nghe</a>
							</li>
...
<div class="page-content">
	<c:if test="${msgmanagelisten!=''}">
		<h4 class="pink">
			<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
			<a  class="green" data-toggle="modal">${msgmanagelisten }</a>
		</h4>
	</c:if>
				...
				<table id="simple-table" class="table  table-bordered table-hover">
					<thead>
						<tr>
						   ...
						   <th class="center">
					        ...
					        <th class="center">
				   				Thêm nội dung bài kiểm tra nghe
					        </th>
								<!--  
							<th class="center">
					         check nội dung
					...
					<tbody>		
                          <c:forEach items="${listlisten}" var="list">
										<tr>
											<td class="center">
												<c:out value="${list.idlistenexercise}" />	
											</td>
											<td class="center">
										 		<c:out value="${list.listenexercisename}" />		
											</td>
											<td class="center">
												<c:out value="${list.listenexerciseimage }" />		
											</td>
											<td class="center">
												<a class="red" href="DeleteListen?idlistenexercise=${list.idlistenexercise}">
													<i class="ace-icon fa fa-trash-o bigger-130"></i>
												</a>
											</td>
											<td class="center">
													<a class="green" href="AddListenQuestion?idlistenexercise=${list.idlistenexercise }">
														<ul class="list-unstyled">
															<c:if test="${list.checklisten==1}">
															    <li>
														            <i class="ace-icon fa fa-check-square-o"></i>
												            	</li>
												      	    </c:if>
												           	<c:if test="${list.checklisten==0}">
															     <li>
		...
		<div>
			<ul class="pagination">										
               <c:if test="${numberpage==1}"> 
					...
					<li><a href="ListListenManage?pageid=${numberpage+1}">Next</a></li>
			   </c:if>
	
				<c:if test="${numberpage==maxpageid}"> 
					    <li><a href="ListListenManage?pageid=${numberpage-1}">Prev</a></li>   
						<li class="disabled"><a href="#">Next</a></li>	
				</c:if>
				
				<c:if test="${numberpage > 1 && numberpage < maxpageid}"> 
						<li><a href="ListListenManage?pageid=${numberpage-1}">Prev</a></li> 
						<li><a href="ListListenManagey?pageid=${numberpage+1}">Next</a></li>
				</c:if>
			 </ul>
        </div>
	</div>
...
<div class="row">
	<div class="col-xs-12">
		<button type="button" class="btn btn-white btn-warning btn-bold" data-toggle="modal" data-target="#myModal1">
	       Thêm hình ảnh và audio
    	</button>							
	</div>
</div>		
 ...
 <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
       <form action="AddListenName" method="post">
    	  <!-- Modal content-->
      	<div class="modal-content">
       		 <div class="modal-header">
         		 <button type="button" class="close" data-dismiss="modal">&times;</button>
        		  <h4 class="modal-title"> Thêm tên bài tập nghe</h4>
        </div>
      <div class="modal-body">
		<div class="form-group">
         	<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">  Thêm tên bài tập nghe</label>
				<div class="col-sm-9">
					<input type="text" id="form-field-1-1" placeholder="Nhập tên chủ đề" class="form-control" name="listenexercisename"/>
				</div>
		</div>
 ...
 <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
       <form action="AddListenAudioimage" method="post" enctype="multipart/form-data">
    	  <!-- Modal content-->
      	<div class="modal-content">
       		 <div class="modal-header">
         		 <button type="button" class="close" data-dismiss="modal">&times;</button>
        		  <h4 class="modal-title"> Thêm hình ảnh và audio</h4>
        </div>
