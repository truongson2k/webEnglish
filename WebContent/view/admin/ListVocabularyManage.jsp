...
<div class="page-content">
	<c:if test="${msgmanagevocabulary!=''}">
		<h4 class="pink">
			<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
			<a  class="green" data-toggle="modal">${msgmanagevocabulary }</a>
		</h4>
	</c:if>
				...
				<table id="simple-table" class="table  table-bordered table-hover">
					...
					<tbody>		
                          <c:forEach items="${listvocabulary}" var="list">
										<tr>
											<td class="center">
												<c:out value="${list.idvocabularyguideline}" />	
											</td>
											<td class="center">
										 		<c:out value="${list.vocabularyname}" />		
											</td>
											<td class="center">
												<c:out value="${list.vocabularyimage }" />		
											</td>
											<td class="center">
												<a class="red" href="DeleteVocabulary?idvocabularyguideline=${list.idvocabularyguideline}">
													<i class="ace-icon fa fa-trash-o bigger-130"></i>
												</a>
											</td>
											<td class="center">
													<a class="green" href="Addvocabularycontent?idvocabularyguideline=${list.idvocabularyguideline }">
		...
		<div>
			<ul class="pagination">										
               <c:if test="${numberpage==1}"> 
					...
					<li><a href="Displaylistvocabulary?pageid=${numberpage+1}">Next</a></li>
			   </c:if>
	
				<c:if test="${numberpage==maxpageid}"> 
					    <li><a href="Displaylistvocabulary?pageid=${numberpage-1}">Prev</a></li>   
...
<div class="row">
 ...
 <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
       <form action="AddVocabularytopic" method="post">
    	  <!-- Modal content-->
      	<div class="modal-content">
       		 <div class="modal-header">
         		 <button type="button" class="close" data-dismiss="modal">&times;</button>
        		  <h4 class="modal-title">Thêm tên chủ đề</h4>
        </div>
      <div class="modal-body">
		<div class="form-group">
         	<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Thêm tên chủ đề</label>
				<div class="col-sm-9">
					<input type="text" id="form-field-1-1" placeholder="Nhập tên chủ đề" class="form-control" name="vocabularyname"/>
				</div>
		</div>
 ...
 <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
       <form action="Addvocaaudioimage" method="post" enctype="multipart/form-data">
    	  <!-- Modal content-->
      	<div class="modal-content">
       		 <div class="modal-header">
         		 <button type="button" class="close" data-dismiss="modal">&times;</button>
