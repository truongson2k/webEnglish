							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										...
										<form action="Uploadtopicvocaimage?idvocabularyguideline=<%=request.getAttribute("idvocabularyguideline") %>" method="post" enctype="multipart/form-data">
												<fieldset>
												<span style="color: red">${messageError}</span>
												  <label class="block clearfix">
												  <%=request.getAttribute("msgthemchude")!=null?request.getAttribute("msgthemchude"):""%>
												  </label>
													<label class="block clearfix">
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-70 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm hình chủ đề từ vựng</span>
														</button>
													</div>
